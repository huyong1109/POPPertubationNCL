...
!-----------------------------------------------------------------------
   ...
   do iblock=1,numBlocks
      ...
      do j=1,ny
      do i=1,nx
         WORKN(i,j,1,iblock) = R(i,j,iblock)*R(i,j,iblock)
         S(i,j,iblock) =  R(i,j,iblock)
      end do
      end do
...
!-----------------------------------------------------------------------
      ...
      do iblock=1,numBlocks
        ...
        call btropOperator(AZ,-R,iblock)
         ...
         do i=1,nx
            WORKN(i,j,1,iblock) =  R(i,j,iblock)*R(i,j,iblock)
            WORKN(i,j,2,iblock) = AZ(i,j,iblock)*R(i,j,iblock)
         end do
         end do
...
!-----------------------------------------------------------------------
      ...
      do iblock=1,numBlocks
         ...
         do j=1,ny
         do i=1,nx
            S(i,j,iblock) =  R(i,j,iblock) + cgBeta *S(i,j,iblock)
...
!-----------------------------------------------------------------------
   ...
   do iblock=1,nb
        call btropOperator(WORK1,-Q,iblock)
